package io.github.trashoflevillage.darkdungeons.client.entity.models;
...
public class EnchanterEntityModel<T extends EnchanterEntity> extends SinglePartEntityModel<T> implements ModelWithArms, ModelWithHead {
	...
	public EnchanterEntityModel(ModelPart root) {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData hat = head.addChild("hat", ModelPartBuilder.create().uv(32, 0).cuboid(-5.0F, -13.0F, -5.0F, 10.0F, 8.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData arms = body.addChild("arms", ModelPartBuilder.create().uv(44, 22).cuboid(-8.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(0.0F))
				.uv(32, 46).cuboid(4.0F, -1.0F, -2.0F, 4.0F, 8.0F, 4.0F, new Dilation(0.0F))
				.uv(40, 38).cuboid(-4.0F, 3.0F, -2.0F, 8.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 2.0F, 0.0F, -0.75F, 0.0F, 0.0F));
		...
		ModelPartData rightArm = body.addChild("rightArm", ModelPartBuilder.create().uv(48, 46).mirrored().cuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-5.0F, 2.0F, 0.0F));

		ModelPartData rightItem = rightArm.addChild("rightItem", ModelPartBuilder.create(), ModelTransform.pivot(-0.5F, 6.0F, 0.5F));

		ModelPartData leftArm = body.addChild("leftArm", ModelPartBuilder.create().uv(48, 46).cuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(5.0F, 2.0F, 0.0F));
