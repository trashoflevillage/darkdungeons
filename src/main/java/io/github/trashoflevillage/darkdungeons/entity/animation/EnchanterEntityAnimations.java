package io.github.trashoflevillage.darkdungeons.entity.animation;
...
public class EnchanterEntityAnimations {
    public static final Animation ENCHANTER_CASTING = Animation.Builder.create(16.6667F).looping()
    ...
    public static final Animation ENCHANTER_GENERAL = Animation.Builder.create(0.0F).looping()
    ...
    public static final Animation ENCHANTER_MOVE = Animation.Builder.create(0.0F).looping()
